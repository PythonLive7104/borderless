...
function Visitors() {
  ...
  async function load() {
    ...
    setLoading(true);
    try {
      setRows((await analyticsApi.visitors(current.id, { search, device })).results);
    } finally {
      setLoading(false);
    }
  }
  ...
  }, [current == null ? void 0 : current.id, search, device]);
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    loading ? /* @__PURE__ */ jsx("div", { className: "grid place-items-center py-16", children: /* @__PURE__ */ jsx("div", { className: "h-8 w-8 animate-spin rounded-full border-2 border-line border-t-brand" }) }) : rows.length === 0 ? /* @__PURE__ */ jsx("div", { className: "card shadow-soft mt-5", children: /* @__PURE__ */ jsx(NoData, { msg: "No visitors match." }) }) : /* @__PURE__ */ jsx("div", { className: "card shadow-soft mt-5 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
