...
import { d as useDialog, c as useWorkspace, B as Button, N as keysApi } from "../entry-server.js";
...
function ApiKeys() {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs(PageNote, { id: "api-keys", children: [
      "API keys let your own systems talk to TryNoBot securely — for example, to record a sale from your server. Create a key, copy it ",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-fg-muted", children: "Authenticate server-side requests to the TryNoBot API." })
      ] }),
