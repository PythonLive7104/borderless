...
import { A as useDialog, B as Button, E as ipFilterApi, c as useWorkspace, R as RULE_FIELDS, F as ruleApi, x as websiteApi } from "../entry-server.js";
import { M as Modal } from "./Modal-CCIcMfR1.js";
import { F as Field } from "./Field-Cq1XQP8x.js";
import { A as ACTION_META, a as actionTone, f as fieldLabel, o as opLabel, v as valueLabel, b as opsFor, C as CondValue, c as ACTIONS, R as REDIRECT_PRESETS, d as REDIRECT_ORIGIN, e as emptyCond } from "./ruleFields-BHbrkhqx.js";
...
function TrafficRules() {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx(Modal, { open, onClose: closeModal, size: "wide", title: editingId ? "Edit traffic rule" : "New traffic rule", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-4", children: [
