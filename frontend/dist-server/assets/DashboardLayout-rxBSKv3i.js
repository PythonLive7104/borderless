...
import { c as useWorkspace, d as billingApi, u as useAuth, B as Button, a as authApi, L as Logo } from "../entry-server.js";
import { T as TourProvider } from "./TourContext-CcD2pnE8.js";
...
function openTawk() {
  ...
  const w = window;
  if (!TAWK_SRC) {
    window.open("mailto:support@trackaudit.info?subject=Support%20request", "_blank");
    return;
  }
    ...
    open && /* @__PURE__ */ jsxs("div", { className: "fixed bottom-24 right-5 z-[90] flex h-[30rem] w-[22rem] max-w-[calc(100vw-2.5rem)] flex-col overflow-hidden rounded-2xl border border-line bg-white shadow-[0_30px_80px_-20px_rgba(0,0,0,.35)]", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-line bg-bg-soft px-4 py-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "text-[11px] text-fg-dim", children: "Ask about anything in TrackAudit" })
        ] }),
        /* @__PURE__ */ jsxs(
          "button",
          {
...
function AccessGate({ children }) {
  ...
  if (access.locked && !onBilling) {
    ...
    return /* @__PURE__ */ jsx("div", { className: "grid min-h-[60vh] place-items-center px-4", children: /* @__PURE__ */ jsxs("div", { className: "card shadow-soft max-w-md p-8 text-center", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-fg-muted", children: canceled ? "Reactivate a plan to regain access to your workspace, traffic data and rules." : "Thanks for trying TrackAudit! Choose a plan to keep filtering traffic and unlock your dashboard again." }),
      /* @__PURE__ */ jsx(
        Link,
        {
          to: BILLING_PATH,
...
function SidebarLink({ item, onNavigate }) {
  if (item.soon || !item.to) {
    return /* @__PURE__ */ jsxs("span", { className: "flex cursor-not-allowed items-center justify-between rounded-lg px-3 py-2 text-sm text-fg-dim/70", children: [
      item.label,
  ...
  return /* @__PURE__ */ jsx(
    NavLink,
    {
      ...
      onClick: onNavigate,
      className: ({ isActive }) => `block rounded-lg px-3 py-2 text-sm font-medium transition ${isActive ? "bg-brand/10 text-brand" : "text-fg-muted hover:bg-bg-mute hover:text-fg"}`,
      children: item.label
    }
  );
}
