...
function HelpVideo({
  ...
  return /* @__PURE__ */ jsx("div", { className: "mb-5", children: !open ? /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "pulse-red grid h-14 w-14 shrink-0 place-items-center rounded-full bg-red-600 text-white transition group-hover:scale-105 sm:h-16 sm:w-16", children: /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", className: "h-6 w-6 translate-x-[2px] sm:h-7 sm:w-7", fill: "currentColor", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { d: "M8 5v14l11-7z" }) }) }),
