...
const linkApi = {
  ...
  verifyCustomDomain: (id) => http.post(`/links/domains/${id}/verify/`, {}),
  removeCustomDomain: (id) => http.del(`/links/domains/${id}/`),
...
const ruleApi = {
  list: (orgId, shortLink) => http.get(`/rules/?${qs({ organization: orgId, short_link: shortLink })}`),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("section", { className: "hero-band relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "container-page relative py-16 text-center", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mx-auto mt-4 max-w-xl text-slate-300", children: "Weekly or monthly access — renew when it runs out, and unused days roll over. Pay with cryptocurrency." })
      ] })
    ] }),
