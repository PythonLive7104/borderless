...
export const KB: KBEntry[] = [
  ...
  { q: "What are the plans and limits?", keywords: ["plan", "pricing", "billing", "price", "cost", "limit", "events", "upgrade", "subscription"],
    a: "Three tiers, billed weekly or monthly — your choice on the Billing page. Basic $25/week or $69/month (100k events, 30-day retention, 5 domains weekly / 10 monthly, 2 redirects weekly / 5 monthly). Plus $40/week or $119/month (300k events, 90-day, 10/20 domains, 5/10 redirects). Pro $70/week or $199/month (1M events, 365-day, 20/40 domains, 10/20 redirects). Monthly costs less than four weeks and doubles the domain and redirect limits. Pay by card or cryptocurrency through our secure hosted checkout (Bachs); the price you see is the price you pay, we cover the processing fee." },
