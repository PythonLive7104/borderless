...
export const KB: KBEntry[] = [
  ...
  { q: "What does each action mean?", keywords: ["action", "redirect", "review", "tag", "block", "allow", "mean"],
    a: "Allow = let them through. Redirect = send them to a URL you choose (e.g. bots to a safe page). Block = stop them. Flag for review = just mark the visit to inspect later. Tag = attach a custom label for reports. Only Redirect changes what the visitor sees." },
