...
const CONTENT: Record<string, { title: string; intro: string; sections: [string, string][] }> = {
  terms: {
    ...
    intro: "These terms govern your use of the Borderless platform. This is placeholder MVP copy — replace with counsel-reviewed terms before launch.",
    sections: [
      ["Acceptable use", "Borderless may be used only for legitimate traffic-quality, fraud detection and analytics. Using it to deceive advertising networks or evade platform enforcement is prohibited."],
