      ...
      {res?.ok && (
        <div className="mx-auto mt-12 max-w-2xl">
          ...
          <div className="mt-6 rounded-2xl bg-navy-900 p-7 text-center text-white">
            <h3 className="text-xl font-bold">Close these gaps with Borderless</h3>
            <p className="mx-auto mt-2 max-w-md text-sm text-white/70">Borderless scores every visitor in real time, blocks bots and fraud, and shows you exactly what's hitting your site — free to start.</p>
