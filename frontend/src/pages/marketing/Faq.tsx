...
const QA = [
  ["What is Borderless?", "A traffic-intelligence platform that analyzes, scores and classifies your incoming traffic in real time so you can detect fraud, protect campaigns and measure conversions."],
  ["Do you deceive ad networks or hide content from reviewers?", "No. Borderless is built for legitimate traffic-quality, fraud detection and analytics. We don't provide ad-reviewer deception or platform-policy evasion."],
