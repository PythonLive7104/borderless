  ...
  return (
    <div>
      <PageNote id="api-keys">
        API keys let your own systems talk to TryNoBot securely — for example, to record a sale from your server. Create a key, copy it <b>once</b> (we never show it again), and keep it secret like a password.
      </PageNote>
      <div className="flex items-center justify-between">
        <div><h1 className="text-2xl font-extrabold tracking-tight">API Keys</h1>
          <p className="mt-1 text-sm text-fg-muted">Authenticate server-side requests to the TryNoBot API.</p></div>
