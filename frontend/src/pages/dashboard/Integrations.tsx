  ...
  return (
    <div>
      <PageNote id="integrations">
        Integrations are the ways TryNoBot connects to your website and your other tools. Most people start with the <b>JavaScript Tracker</b>; developers can also use the <b>REST API</b> and <b>Webhooks</b>.
      </PageNote>
      <h1 className="text-2xl font-extrabold tracking-tight">Integrations</h1>
      <p className="mt-1 text-sm text-fg-muted">Connect TryNoBot to your site and systems.</p>
