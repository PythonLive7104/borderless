  ...
  return (
    <div>
      <PageNote id="webhooks">
        A webhook lets TryNoBot <b>notify your systems automatically</b> when something happens — like a bot being caught or a sale being made. Enter a web address to send notifications to, and pick which events you care about.
      </PageNote>
