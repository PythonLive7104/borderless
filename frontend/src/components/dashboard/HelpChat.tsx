...
function openTawk() {
  ...
  if (!TAWK_SRC) { window.open("mailto:support@borderless.io?subject=Support%20request", "_blank"); return; }
...
export default function HelpChat() {
  ...
  const [msgs, setMsgs] = useState<Msg[]>([
    { from: "bot", text: "Hi! I'm the Borderless assistant. Ask me anything about using the app — or tap a suggestion below." },
  ]);
      ...
      {open && (
        <div className="fixed bottom-24 right-5 z-[90] flex h-[30rem] w-[22rem] max-w-[calc(100vw-2.5rem)] flex-col overflow-hidden rounded-2xl border border-line bg-white shadow-[0_30px_80px_-20px_rgba(0,0,0,.35)]">
          <div className="flex items-center gap-2 border-b border-line bg-bg-soft px-4 py-3">
            ...
            <div className="flex-1"><div className="text-sm font-bold">Help & answers</div><div className="text-[11px] text-fg-dim">Ask about anything in Borderless</div></div>
