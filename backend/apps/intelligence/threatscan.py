...
def _post_json(url, payload, headers=None):
    ...
    h = {"Content-Type": "application/json", "User-Agent": "TrackAudit/1.0 (+https://trackaudit.info)", "Accept": "application/json"}
    h.update(headers or {})
...
def _vt_scan(url: str) -> int:
    ...
    submit = urllib.request.Request(
        ...
        headers={"x-apikey": _vt_key(), "User-Agent": "TrackAudit/1.0 (+https://trackaudit.info)",
    ...
    get = urllib.request.Request(
        f"{VT_URL}/{url_id}", headers={"x-apikey": _vt_key(), "User-Agent": "TrackAudit/1.0 (+https://trackaudit.info)"}, method="GET")
