...
class ShortLinkSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "organization", "website", "slug", "destination_url", "title",
                  "domain", "domain_host", "active", "bot_action", "challenge", "challenge_style", "forward_params", "forward_param_keys", "block_vpn", "decoy_url", "country_mode", "countries", "device_mode", "devices",
